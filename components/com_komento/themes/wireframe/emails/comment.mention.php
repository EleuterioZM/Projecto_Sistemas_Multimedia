...
<?php echo $this->fd->html('email.heading', 'COM_KT_EMAILS_MENTIONED_TITLE', 'COM_KT_EMAILS_MENTIONED_TITLE_SUBHEADING'); ?>

<?php echo $this->fd->html('email.content', JText::_('COM_KT_EMAILS_MENTIONED_CONTENT'), 'clear'); ?>
