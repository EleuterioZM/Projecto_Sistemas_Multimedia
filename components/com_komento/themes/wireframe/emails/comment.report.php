...
<?php echo $this->fd->html('email.heading', 'COM_KT_EMAILS_NEW_REPORT_HEADING', 'COM_KT_EMAILS_NEW_REPORT_SUBHEADING'); ?>

<?php echo $this->fd->html('email.content', JText::_('COM_KT_EMAILS_NEW_REPORT_CONTENT'), 'clear'); ?>
