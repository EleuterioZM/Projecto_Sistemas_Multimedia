...
class OembedAdapterMixCloud extends OembedAdapter
{
	/**
	...
	{
		if (stristr($url, 'mixcloud.com') === false) {
			return false;
		}
	...
	public function process(&$result)
	{
		...
		$url = 'https://www.mixcloud.com/oembed/?url=' . urlencode($this->url) . '&format=json';
