...
class Responsive
{
	...
	/**
	 * Determines the class name used for the user agent
	 *
	 * @since	1.0.0
	 * @access	public
	 */
	...
	/**
	 * Retrieves the current viewer's user agent
	 *
	 * @since	1.0.0
	 * @access	public
	 */
	...
	{
		$agent = @$_SERVER['HTTP_USER_AGENT'];
		$debug = \JFactory::getApplication()->input->get('debugUA', false, 'bool');
	...
	/**
	 * Specific test to determine if this is an iphone device
	 *
	 * @since	1.0.0
	 * @access	public
	 */
	...
	/**
	 * Specific test to determine if this is an iPad
	 *
	 * @since	1.0.0
	 * @access	public
	 */
