 ...
 * @since       3.2
 */
class JFormFieldOpacitySlider extends JFormFieldNumber
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		return '<span class="opacityvalue">0.0</span><input type="range" name="' . $this->name . '" id="' . $this->id . '"' . ' value="'
			. htmlspecialchars($value, ENT_COMPAT, 'UTF-8') . '"' . $class . $disabled . $readonly
			. $onchange . $max . $step . $min . $autofocus . ' /><span class="opacityvalue">1.0</span>';
	}
}
